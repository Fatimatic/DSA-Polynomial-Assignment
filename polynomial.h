...
public:
    ...
    virtual Polynomial add(const Polynomial& other) const { return Polynomial(); }

    // Return a new polynomial that is the product of this and other
    virtual Polynomial multiply(const Polynomial& other) const { return Polynomial(); }

    // Return a new polynomial that is the derivative of this polynomial
    virtual Polynomial derivative() const { return Polynomial(); }
